...
html_title = u'BartacusTwigBundle Documentation'

# A shorter title for the navigation bar.
html_short_title = u'BartacusTwigBundle'
...
intersphinx_mapping = {
    ...
    'ts-reference': ('https://docs.typo3.org/typo3cms/TyposcriptReference/', None),
}
